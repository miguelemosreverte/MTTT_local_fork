...
SET PACKAGES=mintty,wget,ctags,diffutils,git,git-completion,git-svn,stgit,mercurial,make,boost,automake,libtool,cmake,gcc-g++,python,git,subversion,openssh,tcl,zlib0,zlib-devel,libbz2_devel,unzip,libexpat-devel,libcrypt-devel,xorg-server,xinit,xlaunch,python-pyqt4,lxde-common,xorg-server,xinit,xlaunch
